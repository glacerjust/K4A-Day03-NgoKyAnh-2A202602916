...
class MCPRecruitmentServer:
    ...
    """
    def __init__(self, server_name: str = "recruitment-mcp-server"):
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        # Bước 1: Gọi hàm dispatch_tool_call(tool_name, arguments) để lấy chuỗi JSON kết quả từ Tool Router.
        json_result_str = dispatch_tool_call(tool_name, arguments)
        
        # Bước 2: Chuyển đổi chuỗi JSON kết quả thành Python Dictionary (dùng json.loads).
        content = json.loads(json_result_str)
        
        # Bước 3: Đóng gói phản hồi và trả về Dict theo đúng chuẩn giao thức MCP JSON-RPC 2.0.
        return {
            "jsonrpc": "2.0",
